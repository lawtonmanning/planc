  ...
  template <class MATTYPE>
    class DistIO {
      private:
        ...
        void read_dist_matrix(const std::string filename) {
          ...
          int lsizes[] = {itersplit(global_rows,pr,rrank), itersplit(global_cols,pc,crank)};
          int starts[] = {startidx(global_rows,pr,rrank),  startidx(global_cols,pc,crank)};
      ...
      public:
        ...
        void readInput(const std::string file_name, UWORD m = 0, UWORD n = 0,
          ...
          if (!file_name.compare(0, rand_prefix.size(), rand_prefix)) {
            ...
            rcounts = (int *)malloc(pr*sizeof(int));
            ccounts = (int *)malloc(pc*sizeof(int));
        ...
        const int row_counts() const { return rcounts; }
        const int col_counts() const { return ccounts; }
    };
