...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/dc_hierarchical_speedup.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/synthetic_rank2_strongscaling.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/realworld_rank2_strongscaling.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/synthetic_hier_strongscaling.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/realworld_hier_strongscaling.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/synthetic_sequential_level_breakdown.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[height=1.5in, width=\columnwidth]{plots/synthetic_parallel_level_breakdown.pdf}
...
%\begin{figure}
%\begin{center}
%\includegraphics[height=1.5in, width=\columnwidth]{plots/realworld_parallel_level_breakdown.pdf}
