...
\begin{itemize}
	\item summarize approach: expand binary tree until number of leaves hits desired target
	\item choosing leaf node to split is done using priority queue based on that leaf's score
	\begin{itemize}
		\item score can be defined in multiple ways...
	\end{itemize}
	\item explain frontier nodes
	\item explain \Cref{alg:hiernmf2} notation, fields of nodes, etc.
\end{itemize}
