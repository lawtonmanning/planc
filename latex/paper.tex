...
\GB{use Kuang's related work for NMF (2016 paper for divide-and-conquer NMF in JGO \cite{DKDP17}, use PPoPP \cite{KBP16}/TKDE \cite{KBP17}/arXiv \cite{EH+19-TR} of ours and also Liavas \cite{LK+17b}, pyramid NMF: \doi{10.1109/IJCNN.2003.1224004}}

\subsection{NMF}

\GB{general NMF, BCD/AO algorithms \cite{KHP14}, NNLS \cite{KP11}, R2-HierNMF \cite{KP13,GKP15}, DC-NMF \cite{DKDP17}}

\subsection{Parallel NMF}

\GB{PLANC (PPoPP/TKDE/arXiv) and other related work like Liavas}
