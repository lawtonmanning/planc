...
\usepackage[subtle,tracking=normal,leading=tight,leadingfraction=0.98, indent=tight, wordspacing=normal, bibliography=tight]{savetrees}
...
\begin{IEEEkeywords}
low-rank approximation, distributed-memory parallel algorithms, scalable clustering
\end{IEEEkeywords}
