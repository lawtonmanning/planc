...
\GB{use Kuang's related work for NMF (2016 paper for divide-and-conquer NMF in JGO \cite{DKDP17}, use PPoPP/TKDE/arXiv of ours and also Liavas, pyramid NMF: \doi{10.1109/IJCNN.2003.1224004}}

\subsection{NMF}

\GB{general NMF, BCD/AO algorithms, NNLS, R2-HierNMF \cite{KP13,GKP15}, DC-NMF \cite{DKDP17}}
